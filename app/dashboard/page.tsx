                ...
                >
                  <div className="space-y-4">
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <Link
                        href={`/p/${project.slug}`}
                        className="text-xs font-semibold text-zinc-400 hover:text-yellow-400 border border-white/[0.06] hover:border-yellow-400/20 bg-white/[0.02] px-3 py-1.5 rounded-full transition-all"
                      >
                        View Project →
                      </Link>
                    </div>
